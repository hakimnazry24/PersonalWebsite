            ...
            <div className="animate-fade-down animate-once">
                ...
                <div className="flex justify-center">
                    <div className="m-10 grid grid-cols-3 gap-20">
                        ...
                        <PortfolioCard portfolioLink={"https://motionu.club"} portfolioImage={"/images/motionu_website.png"} portfolioTitle={"Motion-U Club Official Website"} portfolioDesc={"Motion-U Club is a technopreneurship club based in International Islamic University Malaysia. I created the website using NextJs, Tailwind and Contenful Headless CMS."}></PortfolioCard>
                    </div>
                </div>
            </div>
